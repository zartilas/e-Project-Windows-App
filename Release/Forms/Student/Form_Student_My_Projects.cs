...
{
    public partial class Form_Student_My_Projects : Form
    {
        private bool toggle_dropdown = false;
        private String user_am;

        public Form_Student_My_Projects(String user_am)
        {
            InitializeComponent();
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            controlsDesigner.Create_My_Projects_Controls(this, panel_Container, imageList_Buttons, user_am,
